"""
Theme 3 Page for Pillar 2
Domestic Institutions and Value Chains
"""
...
<div class="theme-page-header">
    <h1 style="color: #002B7F; margin-bottom: 0.5rem;">Theme 3: {theme['title']}</h1>
