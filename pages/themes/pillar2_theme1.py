"""
Theme 1 Page for Pillar 2
Sustainable vs. Unsustainable Finance
"""
...
<div class="theme-page-header">
    <h1 style="color: #002B7F; margin-bottom: 0.5rem;">Theme 1: {theme['title']}</h1>
