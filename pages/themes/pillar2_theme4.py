"""
Theme 4 Page for Pillar 2
Ownership Over Economic and Financial Flows
"""
...
<div class="theme-page-header">
    <h1 style="color: #002B7F; margin-bottom: 0.5rem;">Theme 4: {theme['title']}</h1>
